...
class CIFARDataProvider(ImagenetDataProvider):
    ...
    def __init__(
        ...
        self.CIFARpath =r"~/rram_nas_comp_pack/dataset/cifar10"
    ...
    def save_path(self):
        if self._save_path is None:
            ...
            if not os.path.exists(self._save_path):
                self._save_path = os.path.expanduser("~/rram_nas_comp_pack/dataset/cifar10")
