...
__all__ = ["OFAMobileNetV3_small"]


class OFAMobileNetV3_small(MobileNetV3):
    def __init__(
        self,
        n_classes=1000,
        bn_param=(0.1, 1e-5),
        ...
        base_stage_width = [16, 16, 24, 40, 48, 96, 576, 1280]
        ...
        se_stages = [False, False, True, True, True]
        ...
        super(OFAMobileNetV3_small, self).__init__(
    ...
    def config(self):
        return {
            "name": OFAMobileNetV3_small.__name__,
    ...
    def load_state_dict(self, state_dict, **kwargs):
        ...
        super(OFAMobileNetV3_small, self).load_state_dict(model_dict)
