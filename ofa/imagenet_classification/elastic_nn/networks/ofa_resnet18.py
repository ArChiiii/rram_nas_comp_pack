...
from ofa.imagenet_classification.elastic_nn.modules.resnet_dynamic_layers import (
...
class OFAResNet18(ResNets):
    def __init__(
        ...
        n_block_list = [
            base_depth + max(self.depth_list) for base_depth in depth_list
        ]
        stride_list = [1, 2, 2, 2]
        ...
        super(OFAResNet18, self).__init__(input_stem, blocks, classifier)
    ...
    def load_state_dict(self, state_dict, **kwargs):
        ...
        super(OFAResNet18, self).load_state_dict(model_dict)
