...
def train(run_manager, args, validate_func=None):
    ...
    for epoch in range(
        ...
        run_manager.writer.add_scalar('Loss/train', train_loss, epoch)
        run_manager.writer.add_scalar('Top1/train', train_top1, epoch)
        ...
        if (epoch + 1) % args.validation_frequency == 0:
            ...
            run_manager.writer.add_scalar('Loss/val', val_loss, epoch)
            run_manager.writer.add_scalar('Top1/val', val_acc, epoch)
            # best_acc
