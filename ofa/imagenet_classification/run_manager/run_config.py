...
from ofa.imagenet_classification.data_providers import ImagenetDataProvider,CIFARDataProvider,ImgnetTinyDataProvider

__all__ = ["RunConfig","MultiRunConfig", "ImagenetRunConfig", "DistributedImageNetRunConfig"]
...
class MultiRunConfig(RunConfig):
    def __init__(
        self,
        n_epochs=150,
        init_lr=0.05,
        ...
        **kwargs
        ...
        super(MultiRunConfig, self).__init__(
            n_epochs,
            init_lr,
            lr_schedule_type,
            lr_schedule_param,
        ...
        self.training_name = kwargs["training_name"]
    ...
    def data_provider(self):
        if self.__dict__.get("_data_provider", None) is None:
            ...
            elif self.dataset == ImgnetTinyDataProvider.name():
                DataProviderClass = ImgnetTinyDataProvider
            else:
                raise NotImplementedError
            self.__dict__["_data_provider"] = DataProviderClass(
                train_batch_size=self.train_batch_size,
